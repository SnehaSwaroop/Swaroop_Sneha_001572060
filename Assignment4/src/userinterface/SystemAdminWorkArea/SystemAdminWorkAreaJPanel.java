...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTree(){
       ...
       DefaultMutableTreeNode restaurantTree = new DefaultMutableTreeNode("Restaurants");
       DefaultMutableTreeNode deliveryManTree = new DefaultMutableTreeNode("Delivery Men");
       
       CustomerDirectory customers = ecosystem.getCustomerDirectory();
       RestaurantDirectory restaurants = ecosystem.getRestaurantDirectory();
       ...
       if (deliveryMen.getDeliveryManList() != null) {
           for (DeliveryMan man : deliveryMen.getDeliveryManList()) {
               deliveryManTree.add(new DefaultMutableTreeNode(man));
           }
       }
       
       model.setRoot(admin);
       admin.insert(customerTree,0);
       admin.insert(restaurantTree,1);
       admin.insert(deliveryManTree,2);
    ...
    private void btnManageCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageCustomerActionPerformed
       ManageCustomerFirstPage panel = new ManageCustomerFirstPage(userProcessContainer, ecosystem);
    ...
    private void btnManageDeliveryManActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageDeliveryManActionPerformed
       ManageDeliveryManFirstPage panel = new ManageDeliveryManFirstPage(userProcessContainer, ecosystem);
       userProcessContainer.add("ManageDeliveryMan",panel);
       CardLayout layout = (CardLayout)this.userProcessContainer.getLayout();
       layout.next(userProcessContainer);
